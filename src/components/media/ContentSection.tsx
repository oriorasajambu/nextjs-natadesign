                ...
                <div className='lg:w-[1200px] md:w-[864px] sm:w-[608px] xs:w-[280px] lg:px-20 md:px-0 sm:px-0'>
                    <div className='flex flex-row sm:flex-col xs:flex-col gap-[1px] bg-primary mt-20'>
                        <div className='lg:basis-2/3 md:basis-2/3 flex-1 lg:pr-12 md:pr-12 pr-0 bg-[#FFFBF2] flex flex-col'>
                            ...
                            <div className='w-full h-[480px] relative mb-12'>
                        ...
                        <div className='lg:flex md:flex hidden basis-1/3 lg:pl-12 md:pl-12 pl-0 flex-col bg-[#FFFBF2]'>
                            <VerticalArticleComponent api={`${process.env.BASE_URL + 'api/articles/category/all/3'}`} title="Postingan Terbaru" />
                            <Link href={'/articles'} className="font-dm-sans text-partial">Selengkapnya</Link>
                            <VerticalAlbumComponent api={`${process.env.BASE_URL + 'api/albums/3'}`} />
                            <Link href={'/portofolio'} className="font-dm-sans text-partial">Selengkapnya</Link>
                        </div>
                    </div>
                </div>
            </div>
